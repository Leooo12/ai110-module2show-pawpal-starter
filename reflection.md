...
- How did you use AI tools during this project (for example: design brainstorming, debugging, refactoring)?
  ...
  I used AI throughout the project as a design and implementation assistant rather than asking it to build the entire application at once. During the early phases, I used it to brainstorm the object-oriented design, review UML diagrams, and refine class responsibilities. During implementation, I used it to generate method skeletons, explain scheduling algorithms, assist with debugging, and create automated tests. I found that small, focused prompts such as "inspect my current implementation before making changes" and "make only the minimal changes necessary" produced the most useful results because they preserved my existing architecture
...
- Describe one moment where you did not accept an AI suggestion as-is.
  ...
  One example where I did not accept an AI suggestion directly was during the design of the Scheduler. An early suggestion placed the task list inside the Scheduler, but after reviewing the design, I decided that tasks should belong to each Pet while the Scheduler only retrieves and processes them. This better followed object-oriented principles and matched the project requirements.
...
- What part of this project are you most satisfied with?
  ...
  I am most satisfied with the scheduler because it integrates sorting, filtering, recurring tasks, and conflict detection into a modular design. Separating the backend logic from the Streamlit interface also made the system easier to test and maintain

**b. What you would improve**

- If you had another iteration, what would you improve or redesign?

  If I had another iteration, I would improve the scheduling algorithm by supporting overlapping task durations instead of only exact time conflicts. I would also enhance the user interface with more interactive scheduling and editing features.

**c. Key takeaway**

- What is one important thing you learned about designing systems or working with AI on this project?

  This project taught me that good software design starts with a clear architecture rather than writing code immediately. I also learned that AI is most effective as a collaborative tool when used with specific prompts, careful review, and human judgment instead of accepting every suggestion without verification.